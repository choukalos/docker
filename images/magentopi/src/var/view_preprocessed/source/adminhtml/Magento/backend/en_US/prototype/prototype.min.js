...
return{argumentNames:argumentNames,bindAsEventListener:bindAsEventListener,curry:curry,delay:delay,defer:defer,wrap:wrap,methodize:methodize}})());(function(proto){function toISOString(){return this.getUTCFullYear()+'-'+
...
var timer=window.setInterval(function(){try{document.documentElement.doScroll('left');}catch(e){return;}
window.clearInterval(timer);fireContentLoadedEvent();},5);}
