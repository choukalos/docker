...
class InvoiceItemInterfacePersistor
{
     ...
     *
     * @param \Magento\Sales\Model\Spi\InvoiceItemResourceInterface $invoiceItemInterfaceResource
     * @param \Magento\Sales\Api\Data\InvoiceItemInterfaceFactory $invoiceItemInterfaceFactory
            ...
            do {
                ...
                if (isset($this->entitiesPool[$hash])) {
                    ...
                    if ($data['action'] == 'created') {
                        $this->invoiceItemInterfaceResource->save($entity);
                        $ids[] = $entity->getId();
                    } else {
                        $ids[] = $entity->getId();
                        $this->invoiceItemInterfaceResource->delete($entity);
                    }
                }
