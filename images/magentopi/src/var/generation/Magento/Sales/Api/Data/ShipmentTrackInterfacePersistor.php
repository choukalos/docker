...
class ShipmentTrackInterfacePersistor
{
     ...
     *
     * @param \Magento\Sales\Model\Spi\ShipmentTrackResourceInterface $shipmentTrackInterfaceResource
            ...
            do {
                ...
                if (isset($this->entitiesPool[$hash])) {
                    ...
                    if ($data['action'] == 'created') {
                        $this->shipmentTrackInterfaceResource->save($entity);
                        $ids[] = $entity->getId();
                    } else {
                        $ids[] = $entity->getId();
                        $this->shipmentTrackInterfaceResource->delete($entity);
                    }
                }
