...
class CreditmemoCommentInterfacePersistor
{
     ...
     *
     * @param \Magento\Sales\Model\Spi\CreditmemoCommentResourceInterface $creditmemoCommentInterfaceResource
     * @param \Magento\Sales\Api\Data\CreditmemoCommentInterfaceFactory $creditmemoCommentInterfaceFactory
            ...
            do {
                ...
                if (isset($this->entitiesPool[$hash])) {
                    ...
                    if ($data['action'] == 'created') {
                        $this->creditmemoCommentInterfaceResource->save($entity);
                        $ids[] = $entity->getId();
                    } else {
                        $ids[] = $entity->getId();
                        $this->creditmemoCommentInterfaceResource->delete($entity);
                    }
                }
